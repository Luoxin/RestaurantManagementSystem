...
<html lang="zh">
 <head> 
  ...
  <title>个人中心 - 首页-member_index.jsp</title> 
...
<![endif]--> 
    ...
    <div class="wash-paper clearfix" id="profile"> 
     <nav class="profile-nav"> 
      <ul class="nav nav-list"> 
       <li class="active"> <a href="member_index.jsp"> <i class="icon-user icon-white"></i> 个人中心 </a> </li> 
       <li class="divider"></li> 
       ...
       <li> <a href="member_pwd.jsp"> <i class="icon-cog"></i> 修改密码 </a> </li> 
 ...
 <div class="content-inner profile-changepwd"> 
       <form class="form-horizontal" method="post" id="changepwd_form" action="updataPassword.jsp"> 
        <fieldset> 
         <div class="control-group clear-fix"> 
          <label class="control-label" for=""><span class="required">*</span>用户ID</label> 
          <div class="controls"> 
          				<% 
	...
	%>
           <input name="old_password" id="sf_guard_user_old_pwd" value=<%=userId%> disabled="true" /> 
         ...
         <div class="control-group"> 
          <label class="control-label" for=""><span class="required">*</span>手机号</label> 
          <div class="controls"> 
           <input name="new_password" id="sf_guard_user_new_pwd"  value=<%=phone%> disabled="true" /> 
