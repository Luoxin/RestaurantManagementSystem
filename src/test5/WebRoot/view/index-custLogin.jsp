...
<body>
    ...
    <div class="login-form">
        ...
        <div class="login-title">普通用户登录</div>
        <form action="user_login_check.jsp" method="post">
			<input name="uname1" type="text" value="" placeholder="用户名" onFocus="this.value = '';" onBlur="if (this.value == '') {this.value = '用户名';}">

            <div class="key">
                <input name="password1" type="password" value="" placeholder="密码" onFocus="this.value = '';" onBlur="if (this.value == '') {this.value = '';this.placeholder='请输入密码'}">
