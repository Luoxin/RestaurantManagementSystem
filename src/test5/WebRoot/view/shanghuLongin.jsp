...
<%
 ...
 %>
    ...
    <div class="login-form">
        ...
        <form action="shanghu_login_check.jsp" method="post">
			<input name="uname1" type="text" value="" placeholder="商戶名" onFocus="this.value = '';" onBlur="if (this.value == '') {this.value = '用户名';}">
