...
<html lang="zh">
 <head> 
  ...
  <title>商户后台管理 - 添加菜品-shanghu_add.jsp</title> 
...
<div class="main-content">
 ...
 <div class="content-inner profile-changepwd"> 
       <form class="form-horizontal" method="post" id="changepwd_form" action="add.jsp"> 
        <fieldset>
          
          <div class="control-group clear-fix">     
          <label class="control-label" for=""><span class="required">*</span>菜品名</label> 
          <div class="controls"> 
           <input name="caipingName" id="" value="" />       
          </div>
          <!--end input--> 
         </div>
         <!--end clearfix-->
         ...
         <div class="control-group">     
          ...
          <div class="controls"> 
           <input name="jiage" id="" value="" onkeyup="value=value.replace(/[^\d]/g,'')" /><span>元</span>
          </div>
          <!--end input--> 
         </div>
         <!--end clearfix-->
          ...
          <div class="controls"> 
           <input name="youhujiage" id="" value="0" onkeyup="value=value.replace(/[^\d]/g,'')" /><span>元</span>
          </div>
          <!--end input--> 
         </div>
         <!--end clearfix-->
