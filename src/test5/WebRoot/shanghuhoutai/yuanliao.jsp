...
<html lang="zh">
 <head> 
  ...
  <title>原料管理 - 显示剩余原料-yuanliao.jsp</title> 
    ...
    <div class="wash-paper clearfix" id="profile"> 
     <nav class="profile-nav"> 
      ...
      <li class="divider"></li> 
       ...
       <li class="divider"></li>   
       <li class="nav-header"> 原料管理</li> 
   	   <li> <a href="yuanliao.jsp"> <i class="icon-file"></i> 原料剩余量 </a> </li> 
...
<div class="main-content">
 ...
 <div class="content-inner profile-changepwd"> 
	...
	ResultSet rs= stm.executeQuery("select * from yuanliao");
	boolean flag = true;
	out.print("<table width='90%' border=1><tr><th>原料名</th><th>原料剩余量<th>预计使用时间</th></tr>");		
	while(rs.next()) {
		...
		if(id.equals(shangJiaID)) {	
			...
			out.print("<td>"+rs.getString("yuanliaoName")+"</td>");
			out.print("<td>"+rs.getString("shengyuliang")+"</td>");
			out.print("<td>"+""+"</td>");
			out.println("</tr>");
		}	
	}
	if(flag) {
		out.println("<tr align='center'>");
		out.print("<td colspan=3>原料已用完！！！</td>");
		out.println("</tr>");
	}
