...
<html lang="zh">
 <head> 
  ...
  <title>商户后台管理 - 折扣管理-zhekou.jsp</title> 
...
<div class="main-content">
 <div class="content-header"> 
  ...
  <div id="div1" class="content-inner profile-changepwd" style="display: "> 
 	<%
 		...
 		out.print("<table width='90%' border=1><tr><th>满减价格</th><th>优惠价格</th><th>开始时间</th><th>结束时间</th><th>操作</th></tr>");
 		while(rs.next()) {	
 			if(shangJiaID.equals(rs.getString("shangJiaID"))) {
	 			out.print("<tr align='center'>");
	 			String mm = rs.getString("manJianJiaGe");
	 			out.print("<td>"+ mm +"</td>");
	 			out.print("<td>"+ rs.getString("youHuiJiaGe") +"</td>");
	 			out.print("<td>"+ rs.getString("kaiShiShiJian") +"</td>");
	 			out.print("<td>"+ rs.getString("jieShuShiJian") +"</td>");
	 			out.print("<td><a href=\"del_zhekou.jsp?manJianJiaGe="+mm+"\">删除</a></td>");
	 			out.print("</tr>");
 			}
 		}
 		out.print("<tr align='center'>");
 		out.print("<td colspan=5><button onclick=\"add()\">添加优惠</button></td>");
 		out.print("</tr>");		
 		out.print("</table>");
 ...
 <div id="div2" class="content-inner profile-changepwd" style="display: none"> 
 		<!-- 添加折扣 -->
       <form class="form-horizontal" method="post" id="changepwd_form" action="zhekouCheck.jsp"> 
        <fieldset>         
          <div class="control-group">     
          <label class="control-label" for="">满减价格</label> 
          <div class="controls"> 
           <input name="manJianJiaGe" id="" value="" onkeyup="value=value.replace(/[^\d]/g,'')" /><span>元</span>
          </div>
          <!--end input--> 
         </div>
         <!--end clearfix-->
          ...
          <div class="control-group">     
          <label class="control-label" for="">优惠价格</label> 
          <div class="controls"> 
           <input name="youhujiage" id="" value="" onkeyup="value=value.replace(/[^\d]/g,'')" /><span>元</span>
          </div>
          <!--end input--> 
         </div>
         <!--end clearfix-->
         ...
         <div class="control-group clear-fix">     
          <label class="control-label" for=""><span class="required">*</span>开始时间</label>
          <div class="controls"> 
           <input name="kaiShiShiJian" id="" value="" onkeyup="value=value.replace(/[^\d]/g,'')" />例：2018年06月18日：20180618      
          </div>
          <!--end input--> 
         </div>
         <!--end clearfix-->
         ...
         <div class="control-group">     
          <label class="control-label" for=""><span class="required">*</span>结束时间</label> 
          <div class="controls"> 
           <input name="jieShuShiJian" id="" value="" onkeyup="value=value.replace(/[^\d]/g,'')" />例：2018年06月18日：20180619
          </div>
          <!--end input--> 
         </div>
         <!--end clearfix-->
          ...
          <button type="submit" class="btn btn-yellow" id="_submit">添加</button>
          <%    
         String  error= "";
